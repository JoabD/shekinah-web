...
<head>
    ...
    <style>
        :root {
            ...
            --blanco: #ffffff;
            --radio: 14px;
            --sombra: 0 10px 30px rgba(16, 28, 54, 0.08);
            --sombra-fuerte: 0 20px 45px rgba(16, 28, 54, 0.16);
        ...
        * {
        ...
        #btn-acceder {
            ...
            font-size: 14px;
            color: #FFFFFF;
            background: linear-gradient(135deg, #0a53be), #0a3622);
            padding: 11px 26px;
            border-radius: 30px;
        ...
        #mision {
            position: relative;
            background: linear-gradient(120deg, var(--azul-oscuro), var(--azul-marino));
            padding: 90px 0;
            text-align: center;
            overflow: hidden;
        }
        ...
        .cta-caja {
            background: linear-gradient(120deg, var(--azul-marino), var(--azul-oscuro));
            border-radius: 20px;
            padding: 60px;
            display: flex;
            align-items: center;
